...
public class VistaRatchet extends VistaAlgoformer {
	...
	protected ImageView vistaRatchet;
	protected VistaRatchetController controllerRatchet;

private GridPane tablero;
	public VistaRatchet(Ratchet ratchet,TableroController tableroController) {
		this.algof=ratchet;
	...
	public void dibujar() {
		try {
			...
			loader3.setLocation(Aplicacion.class.getResource("Ratchet.fxml"));
				...
				/*	File file = new File("C:\\imagenes\\decepticons\\humanoide\\bonecrusher.png");
					...
					picbonecrusher.setId("imagenRatchetHumanoide");
					picbonecrusher.setFitWidth(75);
					picbonecrusher.setFitHeight(75);
					picbonecrusher.setImage(imagebonecrusher);*/
						
			
					this.vistaRatchet = loader3.load();
					
				//	vistaRatchet.getChildren().add(picbonecrusher);
					
					controllerRatchet = loader3.getController();
					
					controllerRatchet.setControllerTablero(tableroController);
					controllerRatchet.setAlgoformer(algof);
					controllerRatchet.dibujar();
				} catch (IOException e) {
